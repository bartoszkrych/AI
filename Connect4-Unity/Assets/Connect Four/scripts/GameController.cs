...
namespace ConnectFour
{
    public class GameController : MonoBehaviour
    {
        ...
        [Range(3, 8)] public int numRows = 6;
        [Range(3, 8)] public int numColumns = 7;
        ...
        public string playerOneWinTxt = "Player One win!";
        public string playerTwoWinTxt = "Player Two win!";
        ...
        void CreateField()
        {
            ...
            for (int x = 0; x < numColumns; x++)
            {
                for (int y = 0; y < numRows; y++)
                {
                    ...
                    GameObject g =
                        Instantiate(pieceField, new Vector3(x, y * -1, -1), Quaternion.identity) as GameObject;
        ...
        GameObject SpawnPiece()
        {
            ...
            GameObject g = Instantiate(
                isPlayerOne ? pieceBlue : pieceRed, // is players turn = spawn blue, else spawn red
                new Vector3(
        ...
        IEnumerator dropPiece(GameObject gObject)
        {
            ...
            for (int i = numRows - 1; i >= 0; i--)
            {
                ...
                {
                    foundFreeCell = true;
                    field[x, i] = isPlayerOne ? (int) Piece.Blue : (int) Piece.Red;
        ...
        IEnumerator Won()
        {
            ...
            for (int x = 0; x < numColumns; x++)
            {
                for (int y = 0; y < numRows; y++)
                {
                    ...
                    if (field[x, y] != (isPlayerOne ? (int) Piece.Blue : (int) Piece.Red))
                    {
                        continue;
                    }
                    ...
                    float length = Vector2.Distance(new Vector2(0, 0),
                        new Vector2(numPiecesToWin - 1, numPiecesToWin - 1));
            ...
            if (gameOver == true)
            {
                winningText.GetComponent<TextMesh>().text = isPlayerOne ? playerOneWinTxt : playerTwoWinTxt;
            }
            else
            {
